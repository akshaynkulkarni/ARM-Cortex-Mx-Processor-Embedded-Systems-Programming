...
__attribute__((naked)) void Handler_HardFault()
{
...
__attribute__((naked)) void Handler_MemManage()
{
...
__attribute__((naked)) void Handler_BusFault()
{
...
__attribute__((naked)) void Handler_UsageFault()
{
...
{
	printf("Init Fault Handlers..\n");
	uint32_t *pSHCSR_REG = (uint32_t *)SHCSR_REG;

	*pSHCSR_REG |= (1 << USGFAULTENA) | (1 << BUSFAULTENA) | (1 << MEMFAULTENA);
